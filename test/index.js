...
var methods = ['assign', 'bind', 'each', 'every', 'filter', 'find', 'get', 'identity', 'indexOf', 'invoke', 'isArray', 'isObject', 'isMatch', 'keys', 'map', 'matches', 'not', 'objectEach', 'objectMap', 'objectReduce', 'pick', 'pluck', 'reduce', 'set', 'some', 'slice', 'unique', 'values']
