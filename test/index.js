...
var methods = ['assign', 'bind', 'each', 'filter', 'find', 'get', 'identity', 'indexOf', 'invoke', 'isMatch', 'keys', 'map', 'matches', 'not', 'objectEach', 'objectMap', 'objectReduce', 'pluck', 'reduce', 'set', 'slice', 'values']
